...
public class Program
{
                ...
                case 1:
                    {
                        ...
                        int ToAdd = ReadIntInRange($"How many students do you want to add? (1-{remainingSlots}): ",
                            1, remainingSlots);
                        ...
                        for (int i = 0; i < ToAdd; i++)
                        {
                            ...
                            newNames[i] = nameInput.Trim();

                            //   credits prompt: $"Enter credits for {newNames[i]} (0-200): " (range 0-200)
                            newCredits[i] = ReadIntInRange($"Enter credits for {newNames[i]} (0-200): ",
                            0, 200);
                ...
                case 3:
                    {
                        ...
                        CopyUsedRoster(rosterNames, rosterCredits, count,
                        out string[] sortedNames, out int[] sortedCredits);
    ...
    private static string[] BuildRosterLines(string[] names, int[] credits, int count)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Lines[i] = string.Format("{0} - {1} credits", names[i], credits[i]);
        }
        return Lines;
    }
